module.exports = {
    ...
    async run(Client, msg, args) {
        ...
        msg.channel.send(`Tag kontrol sistemi başarı ile açıldı, kontrol edilmesi istediğiniz tagları **${config.PREFIX}tagekle** komudu ile ekleyebilir, **${config.PREFIX}tagsil** komudu ile silebilirsiniz.`);
    }
}